...
public class Newsletter {
    ...
    public Newsletter(Long id, String text, String type, String moreInfo, String link, Date creationDateTime) {
        this.id = id;
        this.text = text;
        this.type = type;
    ...
    public Newsletter(Long id, String text, String type, String moreInfo, String link) {
        this.id = id;
        this.text = text;
        this.type = type;
        this.moreInfo = moreInfo;
